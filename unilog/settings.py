...
ADMINS = (
    ('Michal Parkola', 'michal.parkola@gmail.com'),
)
...
SECRET_KEY = '*zzco^7&amp;swhf3$@jj3fuw9v$*1ti+t_8kxu2g8say$(_&amp;!fb90'
...
ROOT_URLCONF = 'unilog.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'unilog.wsgi.application'
